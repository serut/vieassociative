...
return array(
	...
	"facebook_text"=>"Ce site n'a que peu de contenu. Sans votre soutiens, ce projet n'as rien de mieux que ce qui se fait déjà sur la toile. Alors n'hésitez pas à nous partager !",
	"avancement_head"=>"Avancement",
	""=>"",
	""=>"",
	""=>"",
	""=>"",
