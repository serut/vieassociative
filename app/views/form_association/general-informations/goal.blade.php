...
@section('form')
	...
	<textarea data-maxlength="100" rows="3" class="span13" placeholder="{{Lang::get('association/modal_form/general-informations.placeholder_goal')}}" name="goal">{{$val}}</textarea>
    {{ Form::close() }}
