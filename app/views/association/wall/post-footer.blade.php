...
<div class="social-footer">
	...
	<strong>Margo Payne, Tobei Tsumura</strong>and <strong> 3,747 others</strong>like this.
	</div>
	...
	<div class="media">
		...
		<img alt="D" src="http://cesarlab.com/templates/social/assets/img/avatars/d-30x30.png" class="media-object">
		</a>
		<div class="media-body">
		<strong>Margo Payne</strong>
		Where is that?
		<br>
		<small>
	...
	<div class="media">
		<a href="#" class="pull-left">
		<img width="30" height="30" alt="Julio Marquez" src="http://cesarlab.com/templates/social/assets/img/avatar-30.png" class="media-object">
		</a>
		<div class="media-body">
