                ...
                <div class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="inputPassword">Logo  
                                ...
                                <ul id="applications" class="thumbnails portfolio-thumbnails">
                                    ...
                                    <li data-id="id-<?php echo$v['id']; ?>" class="portfolio-item" data-type="util">
                                        <div class="image-wrapper">
                                            ...
                                            <div> 
                                                <a href="<?php echo '/images/original/' . $this->logo['libelle']; ?>" class="first" data-rel="prettyPhoto[gallerie]"><col-lg-><i class="fa fa-zoom-in"></i>Agrandir</col-lg-></a><br>
                                        </div>
                                        </div>
                            ...
                            <?php } else {
                                echo '<div class="control-label col-lg-2"> Vous n\'avez pas encore de logo lié à votre association.</div>';
                            } ?>
                                </div>
                    </div>
